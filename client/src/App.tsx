    ...
    return (
        <div className="flex flex-col justify-center mx-auto">
            ...
            <p className="text-lg mb-6">
                At Currex, we understand that managing currency exchanges can be
                a daunting task, whether you're traveling, investing, or simply
                trying to make informed purchasing decisions. That’s why we’ve
                created a user-friendly platform designed to simplify your
                currency conversion needs.
            </p>
            <h2 className="font-semibold text-2xl mb-6">How it works</h2>
            <p className="text-md mb-6">
                How It Works . Get Instant Results: Click the "Convert" button
                and watch the magic happen—your converted amount will be
                displayed instantly!
            </p>
            <ul className="mb-20 text-sm">
                ...
                <li>
                    ...
                    happen—your converted amount will be displayed instantly!
                </li>
            </ul>
